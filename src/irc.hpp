...
#define ERR_BADCHANNELKEY(nickname, channel_name) ": 475 " + nickname + " " + channel_name + " :Cannot join the channel (+k)\r\n"
...
#define	MSG_INVITEE(nickname, t_nickname, channel_name) ": INVITE " + t_nickname + " :" + channel_name + "\r\n" 
